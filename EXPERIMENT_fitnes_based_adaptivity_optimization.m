...
for meas = 1:measure_num
  ...
  profile on
    wa = WORLD;
    wa = wa.set('space','homo',-500,500,10,'initPopSize',initpopsize,'initSize',islandNum,'structure',wa.cmg('grid',3,3),'fitfunc','rastrigin','vars',struct('generation',1,'convergence',0,'starvtime',0,'stagnation',0,'id',0,'pid',0));
    wa = wa.genesis();
...
w = WORLD;
w = w.set('space','homo',-500,500,10,'initPopSize',initpopsize,'initSize',9,'structure',w.cmg('grid',3,3),'fitfunc','rastrigin');
w = w.genesis();
